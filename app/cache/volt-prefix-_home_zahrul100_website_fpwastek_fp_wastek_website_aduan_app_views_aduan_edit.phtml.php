...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    ?>
              ...
              <form role="form" method="post" action="/aduan/update">
                <div class="box-body">
                  <div class="form-group">
                    <label for="">Judul Pengaduan</label><br>
                    <input type="text" name="judul" value="<?= $aduan->judul ?>">
                        <br>

            <?php echo $this->tag->hiddenField(["id", "value" => $aduan->id]); ?>
                    <label>Isi Pengaduan</label>
                    <textarea name="isi" class="textarea" placeholder="Ketik di sini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $aduan->isi ?></textarea>
                  </div>
                </div>
                <!-- /.box-body -->
