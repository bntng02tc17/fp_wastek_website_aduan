        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="post" action="/pengumuman/update">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="textarea" placeholder="Ketik di sini" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="isi" ><?= $pengumuman->isi ?></textarea>
                  </div>
                </div>
                <!-- /.box-body -->
