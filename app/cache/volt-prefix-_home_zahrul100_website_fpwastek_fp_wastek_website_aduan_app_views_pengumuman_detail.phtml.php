          ...
          <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Detail Pengumuman <span class="label label-primary"><?= $pengumuman->create_on ?></span></h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form">
                <div class="box-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1"><?= $pengumuman->judul ?></label>
